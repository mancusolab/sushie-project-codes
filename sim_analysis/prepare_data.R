...
# 2 pop general data
sushie_pip_pop2 <- read_tsv("~/Documents/github/data/sushie_results/sim2/sushie_2pop_pip.tsv.gz")

susiex_in_pip_pop2 <- read_tsv("~/Documents/github/data/sushie_results/sim2/susiex_in_2pop_pip.tsv.gz")

mesusie_in_pip_pop2 <- read_tsv("~/Documents/github/data/sushie_results/sim2/mesusie_in_2pop_pip.tsv.gz")

xmap_in_pip_pop2 <- read_tsv("~/Documents/github/data/sushie_results/sim2/xmap_in_2pop_pip.tsv.gz")

xmap_ind_pip_pop2 <- read_tsv("~/Documents/github/data/sushie_results/sim2/xmap_ind_2pop_pip.tsv.gz")

sushie_cs_pop2 <- read_tsv("~/Documents/github/data/sushie_results/sim2/sushie_2pop_cs.tsv.gz")

susiex_in_cs_pop2 <- read_tsv("~/Documents/github/data/sushie_results/sim2/susiex_in_2pop_cs.tsv.gz")

mesusie_in_cs_pop2 <- read_tsv("~/Documents/github/data/sushie_results/sim2/mesusie_in_2pop_cs.tsv.gz")
...
ref_param <- read_tsv("~/Documents/github/data/sushie_results/sim2/sushie_2pop_pip.tsv.gz") %>%
...
pop3_pip <- read_tsv("~/Documents/github/data/sushie_results/sim2/sim_3pop_pip.tsv.gz")
pop3_cs <- read_tsv("~/Documents/github/data/sushie_results/sim2/sim_3pop_cs.tsv.gz")
...
sushie_noshared <- read_tsv("~/Documents/github/data/sushie_results/sim2/sushie_noshared_fdr.tsv.gz")

mesusie_noshared <- read_tsv("~/Documents/github/data/sushie_results/sim2/mesusie_in_noshared_fdr.tsv.gz")

susiex_noshared <- read_tsv("~/Documents/github/data/sushie_results/sim2/susiex.in_noshared_fdr.tsv.gz")

xmap_ind_noshared <- read_tsv("~/Documents/github/data/sushie_results/sim2/xmap_ind_noshared_fdr.tsv.gz")

xmap_noshared <- read_tsv("~/Documents/github/data/sushie_results/sim2/xmap_in_noshared_fdr.tsv.gz")
