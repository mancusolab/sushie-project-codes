...
do
  params=`sed "${IDX}q;d" /project/nmancuso_8/zeyunlu/projects/sushie-data-codes/sim_codes/param/param_noshared.tsv`
  echo "NR=${IDX}: ${params}"
  set -- junk $params
  shift
  ...
  TMPDIR=/scratch1/zeyunlu/tmp_noshared/sim${row}_locus${locus}
  mkdir -p $TMPDIR

  OUT=/scratch1/zeyunlu/sushie_sim_noshared
  ...
  python /project/nmancuso_8/zeyunlu/projects/sushie-data-codes/sim_codes/py/run_sushie_noshared.py \
  ${eur1}:${afr1}:${eur2}:${afr2} \
  --N $N \
  --L1 $L1 \
  --L2 $L2 \
  ...
  Rscript /project/nmancuso_8/zeyunlu/projects/sushie-data-codes/sim_codes/R/noshared_susiex.R \
  ...
  Rscript /project/nmancuso_8/zeyunlu/projects/sushie-data-codes/sim_codes/R/noshared_xmap.R \
    ${tmp_output}.in.sim${row}.locus${locus}.rdata \
    $OUT/xmap/xmap.in.sim${row}.locus${locus}

  Rscript /project/nmancuso_8/zeyunlu/projects/sushie-data-codes/sim_codes/R/noshared_xmap2.R \
    ${tmp_output}.in.sim${row}.locus${locus}.rdata \
