...
df_tmp = pd.read_csv(f"{args.w_files}/{args.trait}.normal.sushie.weights.tsv", sep="\t")
...
df_tmp = df_tmp[["chrom", "snp", "pos", "a0", "a1", "ancestry1_sushie_weight", "ancestry2_sushie_weight", "ancestry3_sushie_weight"]]
df_tmp.columns = ["chrom", "snp", "pos", "a0", "a1", "sushie_pop1", "sushie_pop2", "sushie_pop3"]

df_tmp_mega = pd.read_csv(f"{args.w_files}/{args.trait}.normal.mega.weights.tsv", sep="\t")
