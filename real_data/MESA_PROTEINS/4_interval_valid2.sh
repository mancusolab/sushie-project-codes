...
do
  ...
  # sushie
  FILE1=/scratch1/zeyunlu/sushie_proteins/alphas/${pro_ID}.normal.sushie.alphas.tsv
  FILE2=/scratch1/zeyunlu/sushie_interval/alphas/${int_ID}.normal.sushie.alphas.tsv

  OUT=/scratch1/zeyunlu/sushie_proteins/valid2/valid.normal.${pro_ID}.tsv
